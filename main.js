...
const { gssrentbot, conns } = require('./lib/RentBot')
...
👨‍💻 *Owner:* ${repoInfo.owner}`;
 ...
 case 'setimgmenu':
        ...
        if (isBanChat) return m.reply(mess.bangc);
                ...
                await fsx.copy(delb, './lib/allmenu.jpg')
                fs.unlinkSync(delb)
                m.reply(mess.success)
            }
            break
...
case 'runtime': case 'alive':
  if (isBan) return m.reply(mess.banned);
        if (isBanChat) return m.reply(mess.bangc);
                ...
                gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/alive.jpg'),
        caption: pinga,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
╰━━━━━━━━━━━━━━━┈⊷`;
    ...
    if (typemenu === 'v1') {
        gss.sendMessage(m.chat, {
            image: fs.readFileSync('./lib/allmenu.jpg'),
            caption: introText,
            contextInfo: {
                externalAdReply: {
                    showAdAttribution: false,
        ...
        gss.sendMessage(m.chat, {
            video: fs.readFileSync('./lib/gss.mp4'),
            caption: introText,
            sourceUrl: global.link,
            gifPlayback: true
        }, {
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/download.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/searchmenu.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/fun.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/mainmenu.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/aimenu.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./lib/tool.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
